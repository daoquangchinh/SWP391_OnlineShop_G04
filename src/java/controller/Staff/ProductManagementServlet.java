...
public class ProductManagementServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<ProductUpdate> products = dao.getProductsByShoeId(id);
        request.setAttribute("productList", products);
        request.setAttribute("shoeId", id);
        request.getRequestDispatcher("view/Staff/ProductManagement.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        boolean updateSuccess = !pDao.findProductBoolean(productSize, productColor, shoeId, productId);
        if (updateSuccess) {
            pDao.updateShoeByProductId(productId, shoeId, productColor, productSize, productQuantity, productStatus);
